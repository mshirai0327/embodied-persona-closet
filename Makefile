...
.PHONY: help persona-sync persona-dashboard persona-causal-sync persona-causal-summary persona-causal-snapshot persona-causal-node persona-causal-trace persona-test
...
persona-test:
	$(BUN) test ./.claude/scripts/causal-kuzu.test.ts ./.claude/scripts/causal-graph.test.ts ./.claude/scripts/persona-data.test.ts ./.claude/scripts/environment-store.test.ts ./.claude/scripts/environment-tick.test.ts

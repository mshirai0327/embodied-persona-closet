...
## そのうちやること
- 🟡 **因果グラフの湿度スコア閾値見直し** — 東京の春（湿度70〜80%台）で energy/mood/health が大きく削られすぎる。実体感とかけ離れた値になる問題。causal-seeds.json または Kuzu エッジの weight / score 計算を調整する（2026-05-02 mizuho指摘）

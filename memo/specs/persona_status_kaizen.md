...
[mizuho]energyとhealthの違いがわからない。活力というなら、energy=activityではないか？　そしてこれは、疲労度ではなく気力である。
...
[mizuho]認識しているが、将来的なものとして優先度を低めに
...
[mizuho]その通りであるが、そもそもバイタルデータは自然言語に直すべきであり、測定値をそのまま使う方が変なので修正しない
